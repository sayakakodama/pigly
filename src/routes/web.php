...
// もし showRegistrationForm が無いなら、この行は消してください
...
Route::middleware('auth')->group(function () {
    ...
    // ここは typo の可能性が高い（意図ならそのままでOK）
    Route::get('/wizght_logs/goal_setting', [TargetWeightController::class, 'edit'])->name('goal_setting.edit');
    Route::post('/wizght_logs/goal_setting', [TargetWeightController::class, 'update'])->name('goal_setting.update');
